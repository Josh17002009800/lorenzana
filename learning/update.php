...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err && empty($sex_err) && empty($birthdate_err))){
        // Prepare an update statement
        $sql = "UPDATE employees SET name=?, address=?, salary=?, sex=?, birthdate=? WHERE id=?";
